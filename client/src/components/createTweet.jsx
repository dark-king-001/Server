    ...
    return (
        <div className='w-full flex py-1 justify-between px-4 border-b border-b-gray-500 pb-2 border-opacity-50' >
            ...
            <div className='pt-1 flex flex-col items-center w-full' >
                <input id='content' onInput={e => setContent(e.target.value)} type="text" className='w-full outline-none h-[52px] bg-transparent placeholder-gray-600 text-xl' placeholder='Whats on your mind...' />
